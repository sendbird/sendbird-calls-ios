...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "SendBirdCalls",
            url: "https://github.com/sendbird/sendbird-calls-ios/releases/download/1.11.0/SendBirdCalls.xcframework.zip",
            checksum: "83eae012efe3b277ade38754dec0457337199c992c06520d107ac084d5d9bea4"
        ),
